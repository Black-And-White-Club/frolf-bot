...
export type RoundState = "DELETED" | "FINALIZED" | "IN_PROGRESS" | "UPCOMING";
...
export type UserRole = "ADMIN" | "EDITOR" | "RATTLER";
...
export type ResolversTypes = {
  ...
  Participant: ResolverTypeWrapper<
    Omit<Participant, "response"> & { response: ResolversTypes["Response"] }
  >;
  ProcessScoresInput: ProcessScoresInput;
  Query: ResolverTypeWrapper<{}>;
  Response: ResolverTypeWrapper<"ACCEPT" | "TENTATIVE" | "DECLINE">;
  Round: ResolverTypeWrapper<
    Omit<Round, "participants" | "state"> & {
      participants: Array<ResolversTypes["Participant"]>;
      state: ResolversTypes["RoundState"];
    }
  >;
  RoundState: ResolverTypeWrapper<
    "UPCOMING" | "IN_PROGRESS" | "FINALIZED" | "DELETED"
  >;
  ...
  User: ResolverTypeWrapper<
    Omit<User, "role"> & { role: ResolversTypes["UserRole"] }
  >;
  UserInput: UserInput;
...
> = {
  placements?: Resolver<
    Array<ResolversTypes["TagNumber"]>,
    ParentType,
    ContextType
  >;
...
> = {
  ...
  >;
  finalizeAndProcessScores?: Resolver<
    ResolversTypes["Round"],
    ParentType,
    ContextType,
    RequireFields<MutationfinalizeAndProcessScoresArgs, "roundID">
  >;
  joinRound?: Resolver<
    ResolversTypes["Round"],
    ParentType,
  ...
  >;
  linkTag?: Resolver<
    ResolversTypes["TagNumber"],
    ParentType,
    ContextType,
    RequireFields<MutationlinkTagArgs, "discordID" | "newTagNumber">
  >;
  manualTagUpdate?: Resolver<
    ResolversTypes["TagNumber"],
    ParentType,
    ContextType,
    RequireFields<MutationmanualTagUpdateArgs, "discordID" | "newTagNumber">
  >;
  processScores?: Resolver<
    ResolversTypes["Leaderboard"],
    ParentType,
    ContextType,
    RequireFields<MutationprocessScoresArgs, "input">
  >;
  receiveScores?: Resolver<
    ResolversTypes["Leaderboard"],
    ParentType,
    ContextType,
    RequireFields<MutationreceiveScoresArgs, "scores">
  >;
  ...
  submitScore?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationsubmitScoreArgs, "roundID" | "score">
  >;
  updateParticipantResponse?: Resolver<
    ResolversTypes["Round"],
    ParentType,
    ContextType,
    RequireFields<MutationupdateParticipantResponseArgs, "response" | "roundID">
  >;
  updateScore?: Resolver<
    ResolversTypes["Score"],
    ParentType,
    ContextType,
    RequireFields<MutationupdateScoreArgs, "discordID" | "roundID" | "score">
  >;
  updateTag?: Resolver<
    ResolversTypes["TagNumber"],
    ParentType,
    ContextType,
    RequireFields<MutationupdateTagArgs, "discordID" | "tagNumber">
  >;
  updateUser?: Resolver<
    ResolversTypes["User"],
    ParentType,
...
> = {
  getLeaderboard?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QuerygetLeaderboardArgs, "limit" | "page">
  >;
  getRound?: Resolver<
    ResolversTypes["Round"],
    ParentType,
    ContextType,
    RequireFields<QuerygetRoundArgs, "roundID">
  >;
  getRounds?: Resolver<
  ...
  >;
  getScoresForRound?: Resolver<
    Array<ResolversTypes["Score"]>,
    ParentType,
    ContextType,
    RequireFields<QuerygetScoresForRoundArgs, "roundID">
  >;
  getUser?: Resolver<
  ...
  getUserScore?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QuerygetUserScoreArgs, "discordID" | "roundID">
  >;
  getUserTag?: Resolver<
    Maybe<ResolversTypes["TagNumber"]>,
    ParentType,
    ContextType,
    RequireFields<QuerygetUserTagArgs, "discordID">
  >;
};
...
export type RoundStateResolvers = EnumResolverSignature<
  { DELETED?: any; FINALIZED?: any; IN_PROGRESS?: any; UPCOMING?: any },
  ResolversTypes["RoundState"]
>;
...
export type TagNumberResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["TagNumber"] = ResolversParentTypes["TagNumber"]
> = {
...
export type UserRoleResolvers = EnumResolverSignature<
  { ADMIN?: any; EDITOR?: any; RATTLER?: any },
