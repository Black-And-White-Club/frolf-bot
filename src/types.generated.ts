...
> = {
  ...
  processScores?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationProcessScoresArgs, "roundID">
  >;
  ...
  submitScore?: Resolver<
    ...
    ContextType,
    RequireFields<
      MutationSubmitScoreArgs,
      "roundID" | "score" | "tag" | "userID"
    >
  >;
  updateParticipantResponse?: Resolver<
    ...
    ContextType,
    RequireFields<
      MutationUpdateParticipantResponseArgs,
      "response" | "roundID" | "userID"
    >
  >;
...
> = {
  ...
  getUserScore?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryGetUserScoreArgs, "roundID" | "userID">
  >;
  getUserTag?: Resolver<
