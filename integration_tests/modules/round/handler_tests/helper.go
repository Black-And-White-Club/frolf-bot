...
// RoundHandlerTestDeps holds shared dependencies for leaderboard handler tests.
...
func SetupTestLeaderboardHandler(t *testing.T) RoundHandlerTestDeps {
	t.Helper()
	...
	t.Cleanup(func() {
		...
		if roundModule != nil {
			if err := roundModule.Close(); err != nil {
