...
func (m *MockService) OnUserRoleUpdateRequest(ctx context.Context, req userevents.UserRoleUpdateRequestPayload) (*userevents.UserRoleUpdateResponsePayload, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "OnUserRoleUpdateRequest", ctx, req)
	ret0, _ := ret[0].(*userevents.UserRoleUpdateResponsePayload)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockService) OnUserSignupRequest(ctx context.Context, req userevents.UserSignupRequestPayload) (*userevents.UserSignupResponsePayload, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "OnUserSignupRequest", ctx, req)
	ret0, _ := ret[0].(*userevents.UserSignupResponsePayload)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
