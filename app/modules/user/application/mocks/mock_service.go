...
//
//	mockgen -source=./app/modules/user/application/interface.go -destination=./app/modules/user/application/mocks/mock_service.go -package=userservicemock
//

// Package userservicemock is a generated GoMock package.
