...
// Source: ./app/modules/user/domain/types/interface.go
//
// Generated by this command:
//
//	mockgen -source=./app/modules/user/domain/types/interface.go -destination=./app/modules/user/domain/types/mocks/mock_types.go -package=mocks
//
