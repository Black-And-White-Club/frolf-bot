...
//
//	mockgen -source=./app/modules/user/infrastructure/subscribers/interface.go -destination=./app/modules/user/infrastructure/subscribers/mocks/mock_subscribers.go -package=mocks
//
...
func (m *MockUserEventSubscriber) SubscribeToUserEvents(ctx context.Context, eventBus shared.EventBus, handlers userinterfaces.Handlers, logger shared.LoggerAdapter) error {
	m.ctrl.T.Helper()
