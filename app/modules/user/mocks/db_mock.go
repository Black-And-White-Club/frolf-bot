...
//
//	mockgen -destination=mocks/db_mock.go -package=user_mocks -source=db/interface.go UserDB
//
...
func (m *MockUserDB) GetUserByDiscordID(ctx context.Context, discordID string) (*userdb.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserDB) GetUserRole(ctx context.Context, discordID string) (userdb.UserRole, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserDB) UpdateUserRole(ctx context.Context, discordID string, newRole userdb.UserRole) error {
	m.ctrl.T.Helper()
