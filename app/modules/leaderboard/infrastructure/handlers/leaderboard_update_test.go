...
// TestBuildParticipantsFromUpdatePayload_ZeroFinishRankPassesThroughAsZero verifies that
// legacy participants with FinishRank == 0 are forwarded to the service with FinishRank 0
