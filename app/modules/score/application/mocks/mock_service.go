...
func (m *MockService) CorrectScore(ctx context.Context, event scoreevents.ScoreCorrectedEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockService) ProcessRoundScores(ctx context.Context, event scoreevents.ScoresReceivedEvent) error {
	m.ctrl.T.Helper()
