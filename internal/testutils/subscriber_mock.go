...
// Source: github.com/Black-And-White-Club/tcr-bot/app/types (interfaces: Subscriber)
//
// Generated by this command:
//
//	mockgen -destination=internal/testutils/mocks/subscriber_mock.go -package=testutils github.com/Black-And-White-Club/tcr-bot/app/types Subscriber
//
...
func (m *MockSubscriber) Subscribe(ctx context.Context, topic string) (<-chan types.Message, error) {
	m.ctrl.T.Helper()
