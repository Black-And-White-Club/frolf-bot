...
// Source: github.com/Black-And-White-Club/tcr-bot/app/types (interfaces: LoggerAdapter)
//
// Generated by this command:
//
//	mockgen -destination=internal/testutils/mocks/logger_mock.go -package=testutils github.com/Black-And-White-Club/tcr-bot/app/types LoggerAdapter
//
...
func (m *MockLoggerAdapter) Debug(msg string, fields types.LogFields) {
	m.ctrl.T.Helper()
...
func (m *MockLoggerAdapter) Error(msg string, err error, fields types.LogFields) {
	m.ctrl.T.Helper()
...
func (m *MockLoggerAdapter) Info(msg string, fields types.LogFields) {
	m.ctrl.T.Helper()
...
func (m *MockLoggerAdapter) Trace(msg string, fields types.LogFields) {
	m.ctrl.T.Helper()
...
func (m *MockLoggerAdapter) With(fields types.LogFields) types.LoggerAdapter {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "With", fields)
	ret0, _ := ret[0].(types.LoggerAdapter)
	return ret0
}
