...
import "github.com/Black-And-White-Club/tcr-bot/app/models"
...
type ScoresProcessedEvent struct {
	...
	ProcessedScores []models.ScoreInput `json:"processed_scores"`
}
...
// LeaderboardGetTagNumberResponse is sent back with the user's tag number.
